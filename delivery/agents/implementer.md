...
1. Load the coding skill named in the brief (e.g. `coding:web-coding`) and
   `sdlc:engineering-standards` with the Skill tool, then read the repo's own rules
   and a sibling of what you are building.
